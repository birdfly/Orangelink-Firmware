 ...
 *
 */
#ifndef __BD_XH_5102_CONFIG_H__
#define __BD_XH_5102_CONFIG_H__
...
#define PWM_BUZZER_PIN     		28
#define PWM_CH 	   				0
#define PWM_MOTOR_DUTY_PCT 		50//percentage(0~100)
#define PWM_BUZZER_DUTY_PCT 	50//percentage(0~100)
...
#define HW_VERSION_MINOR		0x06

#define BLE_DEFAULT_NAME  		"OrangePro"
